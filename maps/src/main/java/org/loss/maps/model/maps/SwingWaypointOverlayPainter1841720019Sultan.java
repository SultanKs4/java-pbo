 ...
 * @author Daniel Stahr
 */
public class SwingWaypointOverlayPainter1841720019Sultan extends WaypointPainter<SwingWaypoint1841720019Sultan> {

    @Override
    protected void doPaint(Graphics2D g, JXMapViewer jxMapViewer, int width, int height) {
        for (SwingWaypoint1841720019Sultan swingWaypoint : getWaypoints()) {
